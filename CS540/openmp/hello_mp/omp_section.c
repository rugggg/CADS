...
#pragma omp parallel shared(a,b,c,d,nthreads) private(i,tid)
  ...
  #pragma omp sections nowait//sections declares that we have some sections below
                             //nowait specifies that we should break the implicit barroer at the end 
                             //of each of secton - in this case the for loops
    {
    #pragma omp section
      {
